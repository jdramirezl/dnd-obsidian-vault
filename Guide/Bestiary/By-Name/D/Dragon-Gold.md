...
![Gold Dragon](https://www.aidedd.org/dnd/images/gold-dragon.jpg)


> **Source**: Monster Manual pp.113–116
...
> **Type**: Medium dragon, lawful good | **CR**: 3 (700 XP)
...
> **Type**: Large dragon, lawful good | **CR**: 10 (5,900 XP)
...
> **Type**: Huge dragon, lawful good | **CR**: 17 (18,000 XP)
...
> **Type**: Gargantuan dragon, lawful good | **CR**: 24 (36,500 XP)
...
> [!quote] Tactical Deep Dive
> See [[Gold-Dragon-Tactics]] for detailed combat tactics from *The Monsters Know What They're Doing*.


> [!warning] Deadly Encounter
> Ancient Gold Dragon is CR 24 — the highest-CR metallic dragon. Recommended for parties of level 18+. Dual breath weapons (fire cone + Weakening Breath) create devastating tactical choices each round.

> [!tip] DM Tip
> Weakening Breath (Str save) imposes disadvantage on Str-based attacks and halves Str damage — use it on martial-heavy parties to neutralize their damage, then follow up with fire breath on weakened targets.

### Tactical Summary

Gold dragons are the highest-CR metallic dragon (CR 24 Ancient) and among the most dangerous creatures in the Monster Manual. Their dual breath weapons create a devastating tactical choice each round.

**Breath Weapon Priority:**
- **Fire Breath** (90-ft cone, DC 24 Dex, 71 fire damage) — raw damage output against clustered enemies. DEX save targets the weakest save of heavy-armor fighters.
- **Weakening Breath** (90-ft cone, DC 24 Str, disadvantage on Str attacks/checks/saves for 1 min) — use against melee-heavy parties. Disadvantage on Strength-based attack rolls cripples martial characters. STR save means casters are vulnerable too.
- **Combo**: Open with Weakening Breath to debilitate the front line, then switch to Fire Breath on subsequent recharges for damage against weakened foes.

**Change Shape (Adult+):**
- The dragon can polymorph into any humanoid or beast of equal or lower CR. Retains HP, Hit Dice, Int/Wis/Cha, Legendary Resistance, and lair actions.
- Use for infiltration, espionage, or ambush. A gold dragon disguised as a kindly old sage is a classic encounter setup.
- In combat, Change Shape costs an action — generally not worth using mid-fight unless escaping.

**Legendary Actions (3/round):**
- **Wing Attack** (2 actions) is the priority — 15-ft AoE knockdown + reposition. Use to escape melee and force the party to waste movement.
- **Tail Attack** (1 action) for reliable single-target damage at 20-ft reach.
- **Detect** (1 action) to find [[Invisible|invisible]] or hidden creatures.

**Lair Tactics:**
- **Glimpse the Future** gives advantage on everything for a full round — use this on rounds when breath weapon is available for maximum impact.
- **Dream Banishment** (DC 15 Cha) removes one creature from combat entirely. Target the healer or the character with lowest Charisma. The creature must spend its action to attempt escape, wasting its turn even on success.

**Amphibious:** Gold dragons can breathe underwater and swim 40 ft. An underwater lair behind a waterfall negates most fire-based party strategies and limits ranged attacks.

**Key Weaknesses:**
- No cold/lightning resistance — vulnerable to elemental casters.
- Frightful Presence DC 24 is brutal but creatures that save are immune for 24 hours.
- Only 2 lair actions (most dragons get 3) — slightly weaker lair presence.

### Encounter Design

- **Wyrmling (CR 3)**: A young gold dragon might be encountered as a quest-giver or ally. If hostile, it's a solid challenge for level 3–4 parties.
- **Young (CR 10)**: Could be disguised among humanoids. Good for a reveal encounter where the party's "ally" turns out to be a dragon. Level 8–10 parties.
- **Adult (CR 17)**: A major regional power. Likely has agents, informants, and a well-defended lair. Level 13–15 parties.
- **Ancient (CR 24)**: Campaign-defining. An ancient gold dragon is a force of nature — ally or enemy, it reshapes the political landscape. Level 18–20 parties only.
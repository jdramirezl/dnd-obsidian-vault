...
![Ice Devil (Gelugon)](https://www.aidedd.org/dnd/images/ice-devil.jpg)


> **Type**: Large fiend (devil), lawful evil | **CR**: 14 (11,500 XP) | **Source**: Monster Manual p.75
...
The wall lasts for 1 minute or until the devil is incapacitated or dies. Each 10-foot section has AC 5, 30 hit points, vulnerability to fire damage, and immunity to acid, cold, necrotic, poison, and psychic damage. If a section is destroyed, it leaves behind a sheet of frigid air in the space the wall occupied. Whenever a creature finishes moving through the frigid air on a turn, willingly or otherwise, the creature must make a DC 17 Constitution saving throw, taking 17 (5d6) cold damage on a failed save, or half as much damage on a successful one. The frigid air dissipates when the rest of the wall vanishes.

### Variant: Ice Spear

Some ice devils have the following action options instead:
...
See [[Devils-Overview]] for shared devil lore, the infernal hierarchy, and the Nine Hells.
...
> CR 14 — recommended for parties of level 11+. Wall of Ice splits the party (10d6 cold, DC 17 Dex), then it destroys isolated targets with 64 avg melee damage/round. Immune to BOTH cold and fire.

> [!tip] DM Tip
> Open with Wall of Ice to split the party, then engage the weaker half. Every melee attack adds 3d6 cold damage. Unlike most devils, the ice devil is immune to cold AND fire — no elemental weakness exists.

- **Opener:** Wall of Ice to split the party (10d6 cold, DC 17 Dex), then engage isolated targets
- **Melee combo:** Bite + claws + tail = ~64 avg damage/round (each attack adds 3d6 cold)
- **Wall of Ice:** Battlefield control — split party, block retreat, force movement through frigid air
- **Ice Spear variant:** Debilitating — speed reduction + action economy cripple (no action + bonus action)
- **Cold immune:** Unlike most devils, immune to cold AND fire; no elemental weakness
- **Blindsight 60 ft.:** Detects [[Invisible|invisible]] creatures; can't be [[Blinded|blinded]] within 60 ft.
- **Defenses:** AC 18, 180 HP, Magic Resistance, immune to cold/fire/poison
- **Variant:** [[Devils-Overview#Variant: Devil Summoning|Devil Summoning]] — 60% chance to summon 1 ice devil
- **Weakness:** No flight, no ranged attacks; 40 ft. speed is good but can still be kited
- **Encounter use:** Infernal army commanders, Stygia/Cania encounters, pair with [[Devil-Horned|horned devils]] as enforcers

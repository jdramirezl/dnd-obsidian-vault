...
> **Type**: Medium humanoid (kenku), chaotic neutral | **CR**: 1/4 (50 XP) | **Source**: Monster Manual p.194–195
...
> [!tip] DM Tip
> Ambusher gives advantage on attacks during surprise rounds — with Stealth +5, kenku almost always get surprise. Mimicry can lure targets into ambush positions. Communicating with a kenku (they can only mimic sounds) is a great RP puzzle.

- **What it is:** Flightless bird-folk rogues who can only speak by mimicking sounds they've heard. CR 1/4 but excellent ambushers with high Dex. More interesting as NPCs and social encounters than as combat threats.
- **When to use:** Urban criminal encounters, thieves' guild members, forgers, or ambush encounters in alleys and rooftops. Fantastic for roleplay — communicating with a kenku is a puzzle in itself.
- **Key combat tactics:** Ambusher gives advantage on surprise attacks — kenku set up ambushes with Stealth +5. Shortsword and Shortbow both hit at +5 for 1d6+3. They fight dirty, in groups, and flee when outmatched. Mimicry can lure targets into ambush positions.
- **Notable abilities:** Mimicry (DC 14 Insight to detect) is the standout — kenku can perfectly replicate any voice or sound. Ambusher rewards their sneaky nature. High Dex (+3) makes them slippery.
- **Suggested encounter pairings:** A gang of 4–6 kenku ambushing in an alley. Kenku working for a thieves' guild alongside bandits or thugs. A kenku forger as a quest NPC. Pair with a kenku "leader" who communicates entirely through mimicked phrases from different people — great RP moment.

...
class: paladin
tags: [rules, phb, class, paladin, oath-of-the-ancients]
---
...
**Key Concept — The Nature/Fey Paladin: Protect Life and Light.**

### Tenets (Summary)
Kindle the Light · Shelter the Light · Preserve Your Own Light · Be the Light

### Oath Spells
| Level | Spells |
|:-----:|--------|
| 3 | [[Ensnaring Strike|*ensnaring strike*]], [[Speak with Animals|*speak with animals*]] |
| 5 | [[Moonbeam|*moonbeam*]], [[Misty Step|*misty step*]] |
...
- **Nature's Wrath (action):** [[Restrained|Restrain]] a creature within 10 ft (STR or DEX save, its choice; repeats each turn).
- **Turn the Faithless (action):** Fey/fiends within 30 ft make WIS save or are turned for 1 min; reveals true form.

### Subclass Features
| Level | Feature | Effect |
|:-----:|---------|--------|
| 7 | Aura of Warding | Resistance to spell damage, 10 ft (30 ft at 18) |
| 15 | Undying Sentinel | Drop to 1 HP instead of 0 (1/long rest); immune to aging |
| 20 | Elder Champion | 1 min: regen 10 HP/turn, spells as bonus action, enemies have disadvantage on saves within 10 ft |

...
chapter: Ch5
section: Starting Equipment and Wealth
tags:
  - rules
  - basic-rules
  - equipment
...
**Starting Equipment**: Receive gear from your class + background, or roll gold and buy your own.
...
- **Gold Piece (gp)**: Standard unit of wealth; buys a bedroll, 50 ft rope, or a goat
- **Silver Piece (sp)**: 1/10 gp; buys half a day's labor, lamp oil, or a poor inn stay
- **Copper Piece (cp)**: 1/10 sp; buys a candle, torch, or chalk
- **Electrum Piece (ep)**: Worth 5 sp; rare, from fallen empires
- **Platinum Piece (pp)**: Worth 10 gp; rare, from lost kingdoms
...
- **Equipment ([[03-Weapons|weapons]], [[02-Armor-and-Shields|armor]], gear)**: Sells for **half cost** if undamaged
- **Monster gear**: Rarely in good enough condition to sell
- **Magic Items**: Hard to sell; potions/scrolls are easier, other items require wealthy buyers
- **Gems, Jewelry, Art Objects**: Retain **full value**; can be used as currency
- **Trade Goods** (iron bars, salt, livestock): Retain **full value**; used as barter currency

**Key Concept**: Gold pieces are the standard measure of wealth. Equipment sells at half price, while gems and trade goods retain full value. Choose between class-provided starting gear or rolling gold to buy your own.
...
**Hermit**: A recluse who lived in seclusion—in a monastery or entirely alone—finding quiet, solitude, and perhaps answers to life's great questions.

### Proficiencies & Equipment

- **Skill Proficiencies**: [[09-Wisdom|Medicine]], [[08-Intelligence|Religion]]
- **Tool Proficiencies**: [[05-Tools|Herbalism kit]]
- **Languages**: One of your choice

### Equipment

- Scroll case stuffed full of notes from studies or prayers
- Winter blanket
- Set of common clothes
- Herbalism kit
- 5 gp

### Life of Seclusion (d8)
...
- Your extended hermitage gave you access to a **unique and powerful discovery**
- Could be a great truth about the cosmos, deities, outer planes, or forces of nature
- Could be an **unseen site**, a **forgotten fact**, or a **relic** that could rewrite history
- Could be **damaging information** about those who exiled you
- **Work with your DM** to determine the details and campaign impact
...
**Key Concept:** The Hermit background represents a life of contemplative seclusion. Its core mechanical benefit is Discovery, a unique and powerful revelation determined collaboratively with the DM—making it one of the most narratively flexible background features. The background grants Medicine and Religion proficiencies plus herbalism kit and a language, making it ideal for [[01-Cleric-Overview|Clerics]], [[01-Druid-Overview|Druids]], and any character with a mysterious or scholarly past.

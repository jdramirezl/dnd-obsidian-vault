...
**Urchin**: A street survivor who grew up orphaned and poor, learning cunning and self-reliance to stay alive.

### Proficiencies & Equipment

- **Skill Proficiencies**: [[06-Dexterity|Sleight of Hand]], [[06-Dexterity|Stealth]]
- **Tool Proficiencies**: [[05-Tools|Disguise kit]], [[05-Tools|thieves' tools]]
...
- You know the **secret patterns and flow** of cities and can find hidden passages through the urban sprawl
- When not in combat, you and companions you lead can **travel between any two city locations at twice normal speed**
...
**Key Concept:** The Urchin background represents a childhood of desperate poverty on city streets. Its core mechanical benefit is City Secrets, which allows double-speed travel through cities outside of combat. The background grants Sleight of Hand and Stealth proficiencies plus disguise kit and thieves' tools, making it ideal for [[01-Rogue-Overview|Rogues]] and any character with a street-smart urban origin.

...
- **Level/School:** 9th-level abjuration
- **Casting Time:** 1 minute | **Range:** 30 feet
- **Components:** V, S, M (likeness of target + special component worth 500+ gp per Hit Die) | **Duration:** Until dispelled
- **Save:** Wisdom (immune on success if recast)
- **Forms:** Burial (force sphere underground), Chaining ([[Restrained|restrained]] in place), Hedged Prison ([[Demiplane]]), Minimus Containment (shrunk into gemstone), Slumber (eternal sleep).
- **Ending:** Specify a release condition at casting. *[[Dispel Magic|dispel magic]]* works only at 9th level. Reusing the same component frees the previous target.
- **Key Concept:** Permanent imprisonment with multiple forms — the ultimate containment spell.

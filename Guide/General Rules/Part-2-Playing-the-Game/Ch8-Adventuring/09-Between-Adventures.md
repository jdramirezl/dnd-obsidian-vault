...
Practicing a Profession. You can work between adventures, allowing you to maintain a modest lifestyle without having to pay 1 gp per day. This benefit lasts as long you continue to practice your profession.
...
**Between Adventures**: Choose and pay for a lifestyle (see Chapter 5)
- Lifestyle affects how NPCs and groups react to you
- Example: Aristocratic lifestyle → easier to influence nobles

### Downtime Activities

**General Rules**:
- At least **8 hours per day** must be spent on the activity
- Days **don't need to be consecutive**
- Can switch activities between days

> [!tip] DM Tip
> Training a new language or tool proficiency takes **250 days and 250 gp**. Crafting progresses at 5 gp/day. These are great hooks for downtime between adventures — ask players what their characters do between sessions.

### Crafting

**Requirements**: Proficiency with relevant tools + access to materials/facilities
**Progress**: 5 gp worth of items per day
**Cost**: Raw materials = **half the market value**

**Example**: Plate armor (1,500 gp market value)
- Solo: 300 days, 750 gp in materials
- 3 crafters: 100 days, 750 gp total

**Collaboration**: Multiple proficient characters can work together (each contributes 5 gp/day of progress)

**Lifestyle Benefit**: Modest lifestyle free, or comfortable at half cost while crafting

### Practicing a Profession

| Situation | Lifestyle Supported |
|-----------|-------------------|
| Basic work | **Modest** (free) |
| Organization member (temple, guild) | **Comfortable** (free) |
| Performance skill proficiency (performing) | **Wealthy** (free) |

### Recuperating

**Duration**: 3 days of downtime
**Check**: DC 15 Constitution [[11-Saving-Throws|saving throw]]
**On Success** (choose one):
- End one effect preventing you from regaining [[07-Damage-and-Healing|HP]]
- Gain advantage on saves vs. one disease or poison for 24 hours

### Researching

**Process**: DM determines availability, time required, and restrictions
**Possible Checks**: Intelligence (Investigation), Charisma (Persuasion)
**Cost**: 1 gp per day (in addition to lifestyle expenses)
- Includes library access, buying drinks for information, etc.

### Training

**What You Can Learn**: A new language or tool proficiency
**Duration**: **250 days**
**Cost**: **1 gp per day** (250 gp total)
**Requirements**: Find a willing instructor (DM determines availability)

**Key Concept**: Downtime between adventures lets characters craft items (5 gp/day progress at half material cost), practice a profession for free lifestyle, recuperate from conditions, research campaign mysteries, or train new languages/tools (250 days, 250 gp). Days don't need to be consecutive.
consecutive.
